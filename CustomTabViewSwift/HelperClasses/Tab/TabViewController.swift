...
class TabModel: NSObject {
    ...
    init(title: String, img: String, selectedImg: String, badgeCount: String) {
        self.title = title
        self.img = img
...
struct TabCustomParam {
    var equalWidth: Bool = true
    var titleFont: UIFont = UIFont.systemFont(ofSize: 16)
    var titleColor: UIColor = .red
    var selectedViewColor: UIColor = .blue
    var selectedTitleColor: UIColor = .white
    var imgRenderingMode: UIImage.RenderingMode = .alwaysTemplate
    var imgTintColor: UIColor = .red
    var selectedImgTintColor: UIColor = .white
    var showSelectionView: Bool = true
    var showSelectionCorner: Bool = true
    var viewSelectionCornerRadius: CGFloat = 12
    var tabHeight: CGFloat = ipad ? 80 : 60
    var place: TabPlace = .bottom
    var type: TabType = .titleWithImgInTop
    var selectionType: TabSelectionType = .full
    var titleLeadingTrailingSpacing: CGFloat = 5
    var imgTopSpacing: CGFloat = 5
    var imgTitleSpacing: CGFloat = 5
    var imgLeadingSpacing: CGFloat = 5
    var titleTopSpacing: CGFloat = 5
    var titleBottomSpacing: CGFloat = 5
    let screenWidth: CGFloat = UIScreen.main.bounds.size.width
    var viewControllers: [UIViewController] = []
    var tabData: [TabModel] = []
    var selectedControllerIndex: Int = 0
    let viewCenterLeadingTrailing: CGFloat = 0
    let viewCenterTopBottom: CGFloat = 0
    var imgHeight: CGFloat = ipad ? 40 : 20
    var viewMainSpacing: CGFloat = 8
    var viewSelectionHeight: CGFloat = 2
    var addShadow = false
    var shadowColor = UIColor.lightGray
    var shadowOffset: CGSize = CGSize(width: 0, height: 0)
    var shadowOpacity: Float = 0.3
    var cornerRadius: CGFloat = 0
    var cornerTo: UIRectCorner = []
    var edgeInsets: UIEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 0)
    var topSafeAreaSpacing: CGFloat = UIApplication.shared.statusBarFrame.size.height
    var bottomSafeAreaSpacing: CGFloat = UIApplication.shared.keyWindow?.safeAreaInsets.bottom ?? 0
    var tabColor: UIColor = .yellow
    var selectionViewTopBottomSpacing: CGFloat = 4
    var badgeHeight: CGFloat = 15
    var badgeTextColor: UIColor = .white
    var badgeBgColor: UIColor = .red
    var badgeTextFont: UIFont = UIFont.systemFont(ofSize: 12)
    var hideBadgeOnSelection: Bool = false
    var badgePosition: BadgePosition = .aboveImage
...
class TabViewController: UIViewController {
    ...
    //Public
    var customParam = TabCustomParam()
    ...
    //MARK:- Initializers
    convenience init(param: TabCustomParam? = nil, parentVC: UIViewController, toView: UIView) {
