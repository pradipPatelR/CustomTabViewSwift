...
class ViewController: UIViewController {
    ...
    //MARK:- Variables
    //Private
    private var tabParam = TabCustomParam()
    ...
    private func setUpTab() {
        ...
        tabViewController = TabViewController(param: tabParam, parentVC: self, toView: viewContainer)
    }
...
extension ViewController: UITextFieldDelegate {
    func textFieldDidEndEditing(_ textField: UITextField) {
        if (textField == tfCorner) {
            ...
            let dictObj = [TabViewController.Keys.index.rawValue: getInteger(anything: tfIndex.text),
                           TabViewController.Keys.badgeValue.rawValue: getInteger(anything: tfBadgeCount.text)]
